...
| **Workspace** (markdown, skills, agent files) | `workspace/` | `WORKSPACE_DIR` in Settings (config table) or env |
...
**External product site** (APIs, marketing): **https://solanaagent.app** — not the same as your local server URL (**http://127.0.0.1:3333** by default).
